...
**Classify_using_distribution_params**: Contains code for a CNN that trains given inputs being the means and variances of feature distributions from each sequence rather than the sequences themselves.
